...
class FlickrDataset(Dataset):
    def __init__(self, root="data/flickr8k/Flicker8k_Dataset", captions_file="data/flickr8k/captions.txt", transform=None, freq_threshold=5):
        self.root = root
...
def get_loader(root_folder, annotation_file, transform, batch_size=32, num_workers=4, shuffle=True, pin_memory=True):
    ...
    loader = DataLoader(dataset=dataset, batch_size=batch_size, num_workers=num_workers, shuffle=shuffle, pin_memory=pin_memory, collate_fn=Collate(pad_idx=pad_idx))
